# dH 3/2/2023, revised 2023-03-10, revised 2023-03-16
# Mar2023Midterm.py
#
...
# Open the input file
my_file = open("C:/Users/pjkle/Downloads/animalNames.txt", "r", encoding="utf-8")
...
print("\n\n Welcome to Paul's Digital Zoo \n\n")

#################### Input File IO ###########################################
# Open the input file
# You can use with when creating a file object as well, this syntax was easier for me
my_file = open("C:/users/pjkle/downloads/arrivingAnimals.txt", "r", encoding="utf-8")
...
for element in my_array:
    ...
    my_file = open("C:/Users/pjkle/downloads/midTermOutputPython.txt", "w", encoding="utf-8")

    my_file.write("Midterm Program Output; by Dennis Mohle, Spring 2023, Fresno, CA\n")
    my_file.write("Note: This is the approved solution file for Spring 2023 midterm program.\n\n")
